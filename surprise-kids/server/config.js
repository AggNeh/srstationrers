...
const STORE = {
  name: process.env.STORE_NAME || 'Surprise Kids',
  tagline: process.env.STORE_TAGLINE || 'A Unit of RRL Creations',
  ...
  email: process.env.STORE_EMAIL || 'hello@surprisekids.example',
